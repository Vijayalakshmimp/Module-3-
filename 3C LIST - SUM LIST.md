...
3. Define a function createlist(n) that: Initializes an empty list l. Uses a for loop from 12 to n-1. Appends even numbers to the list l.
...
### OUTPUT
<img width="716" height="231" alt="image" src="https://github.com/user-attachments/assets/81a63f53-3d24-4cd1-ba47-929af8ece604" />
